...
_QUESTION_PATTERNS = [
    ...
    # STT 오인식 변형 ("강사님" → "강산님", "강산이")
    r"강산님.{0,80}(모르겠|잘\s*모르|뭐야|뭔가요|뭐예요|돼요|안\s*돼|없어|어떻게)",
    r"강산이.{0,80}(안\s*돼|그렇지|맞지|아닌가요?|주면\s*안)",
    # 강사님 없이 나타나는 명확한 질문
    r"(이거|이게)\s*(왜|어떻게)\s*(이래요?|그래요?)",
    # 질문 명시
