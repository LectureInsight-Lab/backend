...
_ACTION = (
    ...
    r"호출해|테스트해|선언해|완성해|구해|정해)"
)
_ENGAGE_SPECS: list[tuple[str, str]] = [
    ("직접시도",   _ACTION + r"\s*보(?:세요|십시오|실래요)"),   # 해보세요/짜보세요/작성해보세요
    ("직접시도2",  _ACTION + r"\s*봐요"),                        # 해봐요/써봐요
    ("혼자시도",   r"(?:혼자|스스로)\s*\S{0,10}?\s*보(?:세요|십시오)|(?:혼자|스스로)\s*\S{0,10}?\s*봐요"),
]
