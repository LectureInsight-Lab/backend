...
_CHECK_SPECS: list[tuple[str, str]] = [
    # 핵심 마커: (이해/작업이) 되셨어요/되셨나요/되셨죠/됐어요  — 이 강사 최빈
    ("되셨/됐",      r"(?:되셨|됐|되시)(?:어요|나요|죠|어|을까요)"),
    ...
    # 알겠어요/알겠죠/아시겠어요/아시겠죠/아시겠나요
    ("알겠/아시겠",  r"(?:알겠|아시겠)(?:어요|나요|죠|어|지요)"),
    ...
    # 여기까지 (되셨/오셨/확인) — '되셨'과 중복 매칭 방지 위해 '오셨/확인'만 별도
    ("여기까지확인", r"여기까지\s*(?:오셨|확인하셨|확인하세요|오세요|왔어요|이해)"),
]
